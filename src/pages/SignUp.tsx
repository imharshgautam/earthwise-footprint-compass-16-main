...
const SignUp = () => {
  ...
  // Dummy sign up function for UI only
        ...
        <Card className="w-full max-w-md shadow-2xl border-none bg-white/70 dark:bg-green-900/80 glass-effect animate-fade-in backdrop-blur-lg">
          <CardHeader className="flex flex-col items-center space-y-2">
            <span className="flex items-center justify-center rounded-full bg-green-300 h-12 w-12 mb-2 shadow-lg animate-bounce-slow">
              <UserPlus className="text-green-700 h-7 w-7" />
            </span>
          ...
          <CardContent>
            ...
            >
              <div className="space-y-2">
                <Label htmlFor="name" className="font-semibold text-green-900 dark:text-green-100">
                  Name
                </Label>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    disabled={loading}
                  />
                  <Mail className="absolute left-2 top-2.5 h-5 w-5 text-green-400" />
                </div>
              </div>
              <div className="space-y-2">
